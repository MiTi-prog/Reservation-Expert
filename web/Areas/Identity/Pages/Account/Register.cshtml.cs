...
// dodamo za regisrtration 
            [Required(ErrorMessage = "First Name Required")]
            [StringLength(50, ErrorMessage = "Must be under 50 characters")]
            [Display(Name = "First Name")]
            public string FirstName { get; set; } 

//dodamo za registration
...
//dodamo za registration        
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
    /// tuki sem mogu dodat se te forice tipa inputLastName Etc            
                var user = new ApplicationUser { UserName = Input.Email, Email = Input.Email, FirstName = Input.FirstName, LastName = Input.LastName, MobileNumber = Input.MobileNumber  }; // to treba se popravt
